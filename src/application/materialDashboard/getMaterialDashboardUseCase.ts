...
function toRankingItem(material: StockMaterial): DashboardStockRankingItem {
  ...
  return {
    ...
    consumption2021: toDashboardNumber(material.consumption2021),
    consumption2022: toDashboardNumber(material.consumption2022),
    consumption2023: toDashboardNumber(material.consumption2023),
    consumption2024: toDashboardNumber(material.consumption2024),
    consumption2025: toDashboardNumber(material.consumption2025),
    consumption2026: toDashboardNumber(material.consumption2026),
